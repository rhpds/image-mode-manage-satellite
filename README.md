# image-mode-manage-satellite

In this hands-on lab, you will configure Red Hat Satellite to manage RHEL Image Mode Hosts.

**Owner:** nlager
**Migrated from:** https://github.com/rhpds/zt-satellite-image-mode.git
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/image-mode-manage-satellite`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/image-mode-manage-satellite
   ```
3. `cd image-mode-manage-satellite`
